import{i as l,a as f,S as ne,N as re,P as oe,A as Ie,R as $e}from"./assets/vendor-DdBOpbMR.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))o(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const a of n.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&o(a)}).observe(document,{childList:!0,subtree:!0});function s(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function o(r){if(r.ep)return;r.ep=!0;const n=s(r);fetch(r.href,n)}})();const h="/project-CodeWave/assets/sprite-j_Oaob7O.svg";function Se(){const e=document.querySelector(".slider-track"),t=document.querySelectorAll(".slide_active"),s=document.querySelector(".next"),o=document.querySelector(".prev"),r=document.querySelectorAll(".slider-dots li");if(!t.length||!e)return;let n=0;function a(){if(window.innerWidth<768){e.style.transform="none",e.style.transition="none";return}const d=parseFloat(window.getComputedStyle(e).gap)||0,u=t[0].getBoundingClientRect().width+d;e.style.transform=`translateX(-${n*u}px)`,e.style.transition="transform 300ms ease",r.length&&(r.forEach(m=>{m.classList.remove("dot_active"),m.classList.add("dot")}),r[n]&&(r[n].classList.remove("dot"),r[n].classList.add("dot_active")))}function i(){return window.innerWidth>=1440?t.length-1:window.innerWidth>=768?t.length-2:0}s&&s.addEventListener("click",()=>{if(window.innerWidth<768)return;const d=i();n=n>=d?0:n+1,a()}),o&&o.addEventListener("click",()=>{if(window.innerWidth<768)return;const d=i();n=n<=0?d:n-1,a()}),r.length&&r.forEach((d,u)=>{d.addEventListener("click",()=>{if(window.innerWidth<768)return;const m=i();u<=m&&(n=u,a())})}),window.addEventListener("resize",()=>{if(window.innerWidth<768)n=0;else{const d=i();n>d&&(n=d)}a()}),a()}document.addEventListener("DOMContentLoaded",Se);const c=document.querySelector(".desserts-select-wrapper"),M=c.querySelector(".desserts-select-trigger"),Me=c.querySelector(".desserts-select-value"),D=c.querySelector(".desserts-filter"),ae=document.querySelector("[data-categories-loader]"),ie=document.querySelector("[data-list-loader]"),de=document.querySelector(".desserts-list"),$=document.querySelector(".desserts-load-more"),T="https://deserts-store.b.goit.study/api",ce=8;let p=1;document.addEventListener("DOMContentLoaded",Be);$.addEventListener("click",qe);D.addEventListener("click",ke);M.addEventListener("click",Pe);D.addEventListener("click",Oe);document.addEventListener("click",Ae);document.addEventListener("keydown",_e);async function Be(){try{Te(),W(),F();const e=await xe(),t=[{_id:"all",name:"Всі десерти"},...e];Ce(t),document.querySelector(".desserts-filter-button").classList.add("is-active"),Re();const{desserts:s,totalItems:o}=await R(p);if(s.length>0){j(s);const r=document.querySelectorAll(".desserts-card").length;+o>r&&V()}else l.warning({message:"Desserts not found",position:"topRight"})}catch{H()}finally{U()}}async function ke(e){try{if(e.target.nodeName!=="BUTTON")return;const t=e.target.dataset.category;document.querySelectorAll(".desserts-filter-button").forEach(r=>r.classList.remove("is-active")),e.target.classList.add("is-active"),W(),De(),F(),p=1;const{desserts:s,totalItems:o}=t==="all"?await R(p):await le(t,p);if(s.length>0){j(s);const r=document.querySelectorAll(".desserts-card").length;o>r&&V()}else l.warning({message:"Desserts not found",position:"topRight"})}catch{H()}finally{U()}}async function qe(){try{W(),F(),$.disabled=!0,p++;const e=document.querySelector(".desserts-filter-button.is-active").dataset.category,{desserts:t,totalItems:s}=e==="all"?await R(p):await le(e,p);if(t.length>0){j(t);const o=document.querySelectorAll(".desserts-card").length;+s>o?V():Ne()}}catch{H()}finally{U(),$.disabled=!1}}async function xe(){return(await f(`${T}/categories`)).data}async function le(e,t){const{data:s}=await f(`${T}/desserts`,{params:{page:t,limit:ce,category:e}});return s}async function R(e){const{data:t}=await f(`${T}/desserts`,{params:{limit:ce,page:e}});return t}function Ce(e){const t=e.map(({_id:s,name:o})=>`
  ...
  `}const ue=f.create({baseURL:"https://deserts-store.b.goit.study/api"}),me=10;let b=1,pe=0,P=!1,y=null;const fe=e=>ue.get("/desserts",{params:{type:"popular",limit:me,page:e}}).then(t=>t.data),je=e=>ue.get(`/desserts/${e}`).then(t=>t.data),v=document.getElementById("loader");let x=0;function He(){x++,v==null||v.classList.remove("hidden")}function We(){x=Math.max(0,x-1),x===0&&(v==null||v.classList.add("hidden"))}async function _(e){He();try{return await e()}finally{We()}}const ge={position:"topRight",timeout:4e3,transitionIn:"fadeInDown",transitionOut:"fadeOutUp"};function N(e){l.error({title:"Помилка",message:e,...ge})}async function Ue(){if(P)return;if(b*me>=pe){l.info({title:"Інфо",message:"Всі десерти завантажені",...ge});return}P=!0,b++;try{const s=(await _(()=>fe(b))).desserts||[],o=document.getElementById("popularSwiperWrapper");if(!o||!y)return;s.forEach(r=>{const n=document.createElement("div");n.className="swiper-slide",n.innerHTML=A(r),o.appendChild(n)}),y.update(),C(y)}catch(t){N("Помилка підвантаження: "+t.message),b--}finally{P=!1}}async function Ve(){const e=document.getElementById("popularSwiperWrapper");if(!e)return;let t=[];try{t=await _(()=>Promise.all(Y.map(s=>je(s))))}catch{N("Не вдалося завантажити популярні товари");return}e.innerHTML=t.map(s=>`<div class="swiper-slide">${A(s)}</div>`).join(""),y=new ne(".popular-swiper",{modules:[re,oe],slidesPerView:1,watchOverflow:!1,spaceBetween:20,navigation:{prevEl:"#popularPrev",nextEl:"#popularNext",disabledClass:"swiper-button-disabled"},pagination:{el:".popular-pagination",clickable:!0,dynamicBullets:!0,dynamicMainBullets:1},breakpoints:{375:{slidesPerView:1},640:{slidesPerView:2},1024:{slidesPerView:3}},on:{init(s){C(s)},slideChange(s){C(s),s.isEnd&&Ue()}}});try{const s=await _(()=>fe(b)),o=(s.desserts||[]).filter(r=>!Y.includes(r._id));pe=s.totalItems||o.length,o.forEach(r=>{const n=document.createElement("div");n.className="swiper-slide",n.innerHTML=A(r),e.appendChild(n)}),y.update(),C(y)}catch{N("Не вдалося завантажити популярні товари")}}function C(e){const t=document.getElementById("popularPrev"),s=document.getElementById("popularNext");!t||!s||(t.disabled=e.isBeginning,s.disabled=e.isEnd)}Ve();new Ie(".accordion-container",{duration:300,showMultiple:!1});const Fe="https://deserts-store.b.goit.study/api/feedbacks/",ze=8;document.querySelectorAll(".icon-arrow use").forEach(e=>{e.setAttribute("href",`${h}#icon-arrow`)});async function Ke(e=1){try{const{data:t}=await f(Fe,{params:{limit:ze,page:e}});return console.log(t),t}catch(t){console.log(t.message)}}const Ge=document.querySelector(".review-list");function Xe(e){const t=e.map(s=>`
